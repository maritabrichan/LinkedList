...
public class CellListUtilization {
    ...
    public static void main(String[] args) {
		...
		System.out.println("\n\nThe contents of the empty list l2:\n");
		l1.showContents();
		System.out.println("\n\n");
        ...
        //in case the file coule not be opened, display an error message, close the scanner object and exist the program
        ...
        //type is an unused variable that would just ask the user to type anything in order to continue to avoid having the whole program all running at once
        ...
        while(!search){
            ...
            System.out.println("\nPlease enter the serial number of the cellphone that you wish to search for from l1, or enter 0 to skip to the next step");
        ...
        //Display a message indicating what we're doing to the user
        System.out.println("\n\n---------------------------------------TESTING-------------------------------------\n\n");
