	...
	public CellNode find(long serialNum) {
		...
		while (newNode != null) {
			...
			if (newNode.phone.getSerialNum() == serialNum) {
				System.out.println("A phone with the given serial number"+ serialNum+ "at "+ctr + " after " + ctr + " iterations.");
				System.out.println("The information of the celphone is the following: " + newNode.phone.toString());
				return newNode;
			}
